    ...
    <div className="min-h-full">
      ...
      <header className="bg-white shadow">
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold tracking-tight text-gray-900">Javascript Questions</h1>
        </div>
      </header>

      <main className="px-2 mx-auto max-w-7xl py-4 sm:px-6 lg:px-8">
        <div className="flex gap-2 md:gap-8">

          <h2 className="text-md">Debug: </h2>

          <div>
            <input type="checkbox" name="" id="debug" checked={debug} onChange={e => { setDebug(!debug) }} />
            &nbsp;
            <label htmlFor="debug" className="text-lg">Show "Run"</label>
          </div>

          <div>
            <input type="checkbox" name="" id="allowChange" checked={allowChange} onChange={e => { setAllowChange(!allowChange) }} />
            &nbsp;
            <label htmlFor="allowChange" className="text-lg">Allow Change</label>
          </div>
